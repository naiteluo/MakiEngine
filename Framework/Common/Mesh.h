...
namespace Me {
    ...
    public:
        Mesh()
                : m_vertexBuffer(0), m_vertexBufferSize(0), m_vertexCount(0), m_vertexAttributeCount(0),
                  m_indexBuffer(0), m_indexBufferSize(0), m_indexCount(0), m_indexType(IndexSize::kIndexSize16) {};
    ...
    public:
        SimpleMesh() : Mesh(), m_primitiveType(PrimitiveType::kPrimitiveTypeTriList) {};
