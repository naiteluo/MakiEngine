...
namespace Me {
    ...
    private:
        void
        ConvertOddlStructureToSceneNode(const ODDL::Structure &structure, std::unique_ptr<BaseSceneNode> &base_node,
                                        Scene &scene) {
                            ...
                            while (sub_structure) {
                                switch (sub_structure->GetStructureType()) {
                                    ...
                                    case OGEX::kStructureVertexArray: {
                                        ...
                                        SceneObjectVertexArray &_v_array = *new SceneObjectVertexArray(attr,
                                                                                                       morph_index,
                                                                                                       vertexDataType,
                                                                                                       data,
                                                                                                       elementCount);
                                    ...
                                    case OGEX::kStructureIndexArray: {
                                        ...
                                        memcpy(data, _data, buf_size);
                                        SceneObjectIndexArray &_i_array = *new SceneObjectIndexArray(material_index,
                                                                                                     restart_index,
                                                                                                     index_type, data,
                                                                                                     elementCount);
